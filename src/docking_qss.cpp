...
QString DockingQSS::global()
{
    ...
    QString qss = ".ady--DockingWorkbench{background:#eeeef2}"
                  ...
                  ".ady--DockingPaneClient>QTabBar::tab{background-color:#EEEEF2;border-bottom:0;height:24px;padding:0 4px 0 6px;}"
                  ...
                  ".ady--DockingPaneContainer>QTabBar::tab{border:0;background-color:#EEEEF2;height:22px;padding-left:8px;padding-right:8px;color:#444444;border-top:1px solid #ccc;}"
